# VD_04 Знакомство с фреймворком Flask для веб-разработки
...
Главная страница обозначается одним слешем (/) — та страница, которая открывается после захода на сайт. Это не конкретный адрес, а дополнение к адресу.
